...
class StarPizzaRestaurantParser implements IRestaurantParser
{
    ...
    public function __construct (IProductParser $productParser, ICategoryParser $categoryParser)
    {
        ...
        $this->htmlDom = new Htmldom($this->getMainHost().'/orders/?view=rkeeper');
    }
    ...
    public function parse ()
    {
        ...
        $restaurant = Restaurant::where('alias','=', Restaurant::STARPIZZA_RESTAURANT)->first();
        $productIds = array();
        $categoryIds = array();
