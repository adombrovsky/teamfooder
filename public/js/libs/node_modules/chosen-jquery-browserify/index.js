...
//            option_el.innerHTML = option.search_text;
            ...
            return '<li id="' + option.dom_id + '" class="' + classes.join(' ') + '"' + option.style + ' data-option-array-index="'+option.array_index+'">' + html + '</li>';
                ...
                if (this.include_option_in_results(option)) {
                    ...
                    if (!(option.group && !this.group_search)) {
                        ...
                        if (option.search_match) {
                            ...
                            option.search_match = this.options.template ? this.options.template(option.html, option.template_data) : option.html;
